document.addEventListener("DOMContentLoaded", function () {
  ...
  const ayahs = [
    ...
    {
      text: "Say, 'Indeed, my prayer, my rites of sacrifice, my living and my dying are for Allah.'",
      ref: "Qur'an 6:162"
    },
  ...
  function updateDhikr() {
    ...
    void dynamicText.offsetWidth; // Re-trigger animation
  ...
  function showRandomAyah() {
    ...
    // Apply fade-out before changing text
    ayahText.style.opacity = '0';
    ayahText.style.transform = 'translateY(20px)';
    void ayahText.offsetWidth; // Force reflow to restart animation
  ...
  // Set intervals
  setInterval(updateDhikr, 3000); // Change Dhikr every 3s
  setInterval(showRandomAyah, 6000); // Change Ayah every 6s
});
